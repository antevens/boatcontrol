...
F 0 "#PWR02101" H 6400 3050 50  0001 C CNN
...
F 0 "U2101" H 5950 3300 50  0000 L CNN
...
F 0 "#PWR02102" H 6000 3950 50  0001 C CNN
...
F 0 "#PWR02103" H 1950 3200 50  0001 C CNN
...
Wire Wire Line
	6400 3300 6550 3300
$Sheet
S 8050 2750 1000 700 
U 5FE985DA
F0 "3AC3" 50
F1 "3AmpCircuit.sch" 50
F2 "ON" B L 8050 2800 50 
F3 "OFF" B L 8050 2900 50 
F4 "ON_LED" I R 9050 2950 50 
F5 "OFF_LED" I R 9050 2850 50 
F6 "OUT" O R 9050 3400 50 
F7 "IN" I L 8050 3400 50 
F8 "ON_COIL" I R 9050 3150 50 
F9 "OFF_COIL" I R 9050 3250 50 
$EndSheet
Text HLabel 8050 5200 0    50   Input ~ 0
IN_C1
Text HLabel 9050 5200 2    50   Output ~ 0
OUT_C1
$Sheet
S 8050 4550 1000 700 
U D2B5CDA3
F0 "3AC1" 50
F1 "3AmpCircuit.sch" 50
F2 "ON" B L 8050 4600 50 
F3 "OFF" B L 8050 4700 50 
F4 "ON_LED" I R 9050 4750 50 
F5 "OFF_LED" I R 9050 4650 50 
F6 "OUT" O R 9050 5200 50 
F7 "IN" I L 8050 5200 50 
F8 "ON_COIL" I R 9050 4900 50 
F9 "OFF_COIL" I R 9050 5000 50 
$EndSheet
Text HLabel 8050 3400 0    50   Input ~ 0
IN_C3
...
OUT_C3
Text HLabel 8050 4300 0    50   Input ~ 0
IN_C2
Wire Wire Line
	6550 1900 8050 1900
Wire Wire Line
...
F 0 "RN2102" V 9650 4100 50  0000 L CNN
F 1 "680Ω" V 9300 3450 50  0001 L CNN
F 2 "BoatControl:DIP254P762X432-16P" V 10275 3600 50  0001 C CNN
F 3 "https://www.bourns.com/docs/Product-Datasheets/4100R.pdf" H 9800 3600 50  0001 C CNN
F 4 "4116R-1-681LF‎" V 9800 3600 50  0001 C CNN "Product"
F 5 "LED Resistors" V 9800 4350 50  0000 C CNN "Purpose"
	1    9800 3600
	0    1    1    0   
$EndComp
Wire Wire Line
...
F 0 "RN2103" V 1650 3650 50  0000 L CNN
...
F 0 "RN2101" V 1650 2850 50  0000 C CNN
...
F 0 "RN2104" V 1650 4650 50  0000 C CNN
...
Wire Wire Line
	9050 3250 9400 3250
Wire Wire Line
	10150 2950 9050 2950
Wire Wire Line
	10000 3500 10150 3500
Wire Wire Line
	10200 2850 9050 2850
Wire Wire Line
	9050 4900 9500 4900
Wire Wire Line
	9050 5000 9550 5000
...
Wire Wire Line
	9050 4050 9400 4050
Wire Wire Line
	10150 4100 9300 4100
Wire Wire Line
	9300 4100 9300 3850
Wire Wire Line
	9300 3850 9050 3850
$Sheet
S 8050 1850 1000 700 
U 5FEA2B07
F0 "3AC4" 50
F1 "3AmpCircuit.sch" 50
F2 "ON" B L 8050 1900 50 
F3 "OFF" B L 8050 2000 50 
F4 "ON_LED" I R 9050 2050 50 
F5 "OFF_LED" I R 9050 1950 50 
F6 "OUT" O R 9050 2500 50 
F7 "IN" I L 8050 2500 50 
F8 "ON_COIL" I R 9050 2300 50 
F9 "OFF_COIL" I R 9050 2400 50 
$EndSheet
$Sheet
S 8050 3650 1000 700 
U 5FE8B920
F0 "3AC2" 50
F1 "3AmpCircuit.sch" 50
F2 "ON" B L 8050 3700 50 
F3 "OFF" B L 8050 3800 50 
F4 "ON_LED" I R 9050 3850 50 
F5 "OFF_LED" I R 9050 3750 50 
F6 "OUT" O R 9050 4300 50 
F7 "IN" I L 8050 4300 50 
F8 "ON_COIL" I R 9050 4050 50 
F9 "OFF_COIL" I R 9050 4150 50 
$EndSheet
Wire Wire Line
...
F 0 "C2109" H 5800 2600 50  0000 L CNN
...
F 0 "C2110" H 6050 2600 50  0000 L CNN
...
F 0 "#PWR0193" H 6150 2450 50  0001 C CNN
...
F 0 "C2108" V 4100 5550 50  0000 L CNN
...
F 0 "C2107" V 4100 5350 50  0000 L CNN
...
F2 "DIG_OFF" I L 4250 5000 50 
F3 "AN_OFF" I L 4250 5100 50 
...
F 0 "C2106" V 4100 4550 50  0000 L CNN
...
F 0 "C2105" V 4100 4350 50  0000 L CNN
...
F2 "DIG_OFF" I L 4250 4000 50 
F3 "AN_OFF" I L 4250 4100 50 
...
F 0 "C2104" V 4100 3550 50  0000 L CNN
...
F 0 "C2103" V 4100 3350 50  0000 L CNN
...
F 0 "C2102" V 4100 2550 50  0000 L CNN
...
F 0 "C2101" V 4100 2350 50  0000 L CNN
...
U 1 1 6023C2C8
P 1950 2450
AR Path="/D16552B4/5FA17F38/6023C2C8" Ref="#PWR0245"  Part="1" 
AR Path="/D16552B4/5FA17F52/6023C2C8" Ref="#PWR0259"  Part="1" 
AR Path="/D16552B4/5FA17F86/6023C2C8" Ref="#PWR0287"  Part="1" 
AR Path="/D16552B4/5FA17F6C/6023C2C8" Ref="#PWR0273"  Part="1" 
F 0 "#PWR0273" H 1950 2200 50  0001 C CNN
...
U 1 1 6023CA9A
P 1950 4250
AR Path="/D16552B4/5FA17F38/6023CA9A" Ref="#PWR0246"  Part="1" 
AR Path="/D16552B4/5FA17F52/6023CA9A" Ref="#PWR0260"  Part="1" 
AR Path="/D16552B4/5FA17F86/6023CA9A" Ref="#PWR0288"  Part="1" 
AR Path="/D16552B4/5FA17F6C/6023CA9A" Ref="#PWR0274"  Part="1" 
F 0 "#PWR0274" H 1950 4000 50  0001 C CNN
...
U 5 1 6038F064
P 6000 5250
AR Path="/D16552B4/5FA17F38/6038F064" Ref="U303"  Part="5" 
AR Path="/D16552B4/5FA17F52/6038F064" Ref="U1203"  Part="5" 
AR Path="/D16552B4/5FA17F6C/6038F064" Ref="U2103"  Part="5" 
AR Path="/D16552B4/5FA17F86/6038F064" Ref="U3003"  Part="5" 
F 0 "U2103" H 6230 5296 50  0000 L CNN
F 1 "74HC86" H 6230 5205 50  0000 L CNN
F 2 "Package_DIP:DIP-14_W7.62mm" H 6000 5250 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74HC86" H 6000 5250 50  0001 C CNN
	5    6000 5250
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 6039B3AE
P 6000 4750
AR Path="/D16552B4/5FA17F38/6039B3AE" Ref="#PWR0247"  Part="1" 
AR Path="/D16552B4/5FA17F52/6039B3AE" Ref="#PWR0261"  Part="1" 
AR Path="/D16552B4/5FA17F6C/6039B3AE" Ref="#PWR0275"  Part="1" 
AR Path="/D16552B4/5FA17F86/6039B3AE" Ref="#PWR0289"  Part="1" 
F 0 "#PWR0275" H 6000 4600 50  0001 C CNN
...
U 1 1 6039E5BD
P 6000 5750
AR Path="/D16552B4/5FA17F38/6039E5BD" Ref="#PWR0248"  Part="1" 
AR Path="/D16552B4/5FA17F52/6039E5BD" Ref="#PWR0262"  Part="1" 
AR Path="/D16552B4/5FA17F6C/6039E5BD" Ref="#PWR0276"  Part="1" 
AR Path="/D16552B4/5FA17F86/6039E5BD" Ref="#PWR0290"  Part="1" 
F 0 "#PWR0276" H 6000 5500 50  0001 C CNN
...
F1 "MultiVibratorA.sch" 50
F2 "DIG_OFF" I L 4250 2000 50 
F3 "AN_OFF" I L 4250 2100 50 
...
F1 "MultiVibratorB.sch" 50
F2 "DIG_OFF" I L 4250 3000 50 
F3 "AN_OFF" I L 4250 3100 50 
...
U 5 1 603260D8
P 6000 1400
AR Path="/D16552B4/5FA17F38/603260D8" Ref="U302"  Part="5" 
AR Path="/D16552B4/5FA17F52/603260D8" Ref="U1202"  Part="5" 
AR Path="/D16552B4/5FA17F6C/603260D8" Ref="U2102"  Part="5" 
AR Path="/D16552B4/5FA17F86/603260D8" Ref="U3002"  Part="5" 
F 0 "U2102" H 6230 1446 50  0000 L CNN
F 1 "74HC86" H 6230 1355 50  0000 L CNN
F 2 "Package_DIP:DIP-14_W7.62mm" H 6000 1400 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74HC86" H 6000 1400 50  0001 C CNN
	5    6000 1400
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 603260DE
P 6000 900
AR Path="/D16552B4/5FA17F38/603260DE" Ref="#PWR0249"  Part="1" 
AR Path="/D16552B4/5FA17F52/603260DE" Ref="#PWR0263"  Part="1" 
AR Path="/D16552B4/5FA17F6C/603260DE" Ref="#PWR0277"  Part="1" 
AR Path="/D16552B4/5FA17F86/603260DE" Ref="#PWR0291"  Part="1" 
...
U 1 1 603260E4
P 6000 1900
AR Path="/D16552B4/5FA17F38/603260E4" Ref="#PWR0250"  Part="1" 
AR Path="/D16552B4/5FA17F52/603260E4" Ref="#PWR0264"  Part="1" 
AR Path="/D16552B4/5FA17F6C/603260E4" Ref="#PWR0278"  Part="1" 
AR Path="/D16552B4/5FA17F86/603260E4" Ref="#PWR0292"  Part="1" 
F 0 "#PWR0278" H 6000 1650 50  0001 C CNN
...
U 1 1 60337AF6
P 6100 900
AR Path="/60337AF6" Ref="C?"  Part="1" 
AR Path="/D16552B4/5FA17F52/60337AF6" Ref="C1211"  Part="1" 
AR Path="/D16552B4/5FA17F86/60337AF6" Ref="C3011"  Part="1" 
AR Path="/D16552B4/5FA17F38/60337AF6" Ref="C311"  Part="1" 
AR Path="/D16552B4/5FA17F6C/60337AF6" Ref="C2111"  Part="1" 
F 0 "C2111" V 6150 600 50  0000 L CNN
F 1 "0.1uF" H 6191 855 50  0001 L CNN
F 2 "Capacitor_THT:C_Disc_D7.5mm_W5.0mm_P5.00mm" H 6100 900 50  0001 C CNN
F 3 "https://www.mouser.ca/datasheet/2/212/KEM_C1050_GOLDMAX_X7R-1518817.pdf" H 6100 900 50  0001 C CNN
F 4 "Kemet" H 6100 900 50  0001 C CNN "Manufacturer"
F 5 "C320C104K3R5TA" V 6100 900 50  0001 C CNN "Model"
	1    6100 900 
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 60337AFC
P 6200 900
AR Path="/60337AFC" Ref="#PWR?"  Part="1" 
AR Path="/D16552B4/5FA17F52/60337AFC" Ref="#PWR0366"  Part="1" 
AR Path="/D16552B4/5FA17F86/60337AFC" Ref="#PWR0370"  Part="1" 
AR Path="/D16552B4/5FA17F38/60337AFC" Ref="#PWR0364"  Part="1" 
AR Path="/D16552B4/5FA17F6C/60337AFC" Ref="#PWR0368"  Part="1" 
F 0 "#PWR0368" H 6200 650 50  0001 C CNN
F 1 "GND" H 6400 800 50  0000 R CNN
...
U 1 1 60373028
P 6100 4750
AR Path="/60373028" Ref="C?"  Part="1" 
AR Path="/D16552B4/5FA17F52/60373028" Ref="C1212"  Part="1" 
AR Path="/D16552B4/5FA17F86/60373028" Ref="C3012"  Part="1" 
AR Path="/D16552B4/5FA17F38/60373028" Ref="C312"  Part="1" 
AR Path="/D16552B4/5FA17F6C/60373028" Ref="C2112"  Part="1" 
F 0 "C2112" V 6150 4450 50  0000 L CNN
F 1 "0.1uF" H 6191 4705 50  0001 L CNN
F 2 "Capacitor_THT:C_Disc_D7.5mm_W5.0mm_P5.00mm" H 6100 4750 50  0001 C CNN
F 3 "https://www.mouser.ca/datasheet/2/212/KEM_C1050_GOLDMAX_X7R-1518817.pdf" H 6100 4750 50  0001 C CNN
F 4 "Kemet" H 6100 4750 50  0001 C CNN "Manufacturer"
F 5 "C320C104K3R5TA" V 6100 4750 50  0001 C CNN "Model"
	1    6100 4750
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 6037302E
P 6200 4750
AR Path="/6037302E" Ref="#PWR?"  Part="1" 
AR Path="/D16552B4/5FA17F52/6037302E" Ref="#PWR0367"  Part="1" 
AR Path="/D16552B4/5FA17F86/6037302E" Ref="#PWR0371"  Part="1" 
AR Path="/D16552B4/5FA17F38/6037302E" Ref="#PWR0365"  Part="1" 
AR Path="/D16552B4/5FA17F6C/6037302E" Ref="#PWR0369"  Part="1" 
F 0 "#PWR0369" H 6200 4500 50  0001 C CNN
F 1 "GND" H 6400 4650 50  0000 R CNN
